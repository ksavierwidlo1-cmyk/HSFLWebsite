...
export default function ElevateTeamsAdmin() {
  ...
  const [primaryColor, setPrimaryColor] = useState('#8cd2fe');
  ...
  const handleDeleteTeam = async (teamId: string) => {
    ...
    try {
      const response = await fetch(`/api/elevate/teams?id=${teamId}`, {
        method: 'DELETE',
      });
  ...
  const openEditForm = (team: any) => {
    ...
    setPrimaryColor(team.primaryColor || team.colors?.primary || '#8cd2fe');
            ...
            <div>
              ...
              <div className="flex space-x-2">
                ...
                <input
                  ...
                  value={primaryColor}
                  onChange={(e) => setPrimaryColor(e.target.value)}
                  className="flex-1 px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-[#8cd2fe] text-gray-900 dark:text-white"
                />
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {teams.length === 0 ? (
          ...
          teams.map((team) => (
            <div
              key={team.id}
              className="p-6 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-[#8cd2fe] dark:hover:border-[#8cd2fe] transition-colors"
            >
