...
export default function ElevatePlayersAdmin() {
  ...
  const fetchPlayers = async () => {
    try {
      const response = await fetch('/api/elevate/players');
  ...
  const fetchTeams = async () => {
    try {
      const response = await fetch('/api/elevate/teams');
      const data = await response.json();
      setTeams(data);
    } catch (error) {
  ...
  const handleDeletePlayer = async (playerId: string) => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`/api/elevate/players?id=${playerId}`, {
        method: 'DELETE',
      });
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center space-x-2 px-4 py-2 bg-[#8cd2fe] hover:bg-blue-400 text-white rounded-lg font-medium transition-colors"
        >
        ...
        <div className="mb-6 p-6 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-[#8cd2fe] text-gray-900 dark:text-white disabled:opacity-50"
              />
              {!showEditForm && (
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-[#8cd2fe] text-gray-900 dark:text-white"
              />
            </div>
          ...
          <div className="mt-6">
            <button
              ...
              className="flex items-center space-x-2 text-gray-700 dark:text-gray-300 hover:text-[#8cd2fe] dark:hover:text-[#8cd2fe] font-medium"
            >
              <span>{showStats ? '▼' : '▶'}</span>
              ...
              <div className="mt-4 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg grid grid-cols-2 md:grid-cols-4 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-[#8cd2fe] text-gray-900 dark:text-white"
                  />
                </div>
          ...
          <div className="flex space-x-3 mt-6">
            <button
              ...
              disabled={loading}
              className="px-6 py-2 bg-[#8cd2fe] hover:bg-blue-400 text-white rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
      ...
      <div className="mb-4 flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-[#8cd2fe] text-gray-900 dark:text-white"
          />
        </div>
      ...
      <div className="space-y-3">
        {filteredPlayers.length === 0 ? (
          ...
          filteredPlayers.map((player) => (
            <div
              key={player.id}
              className="flex items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-[#8cd2fe] dark:hover:border-[#8cd2fe] transition-colors"
            >
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="p-2 text-[#8cd2fe] hover:bg-blue-50 dark:hover:bg-gray-700 rounded-lg transition-colors"
                  title="Edit player"
                >
      ...
      {showGameStatsModal && gameStatsPlayer && (
        <AddGameStatsModal
          ...
          onSave={async (gameStats) => {
            try {
              const response = await fetch('/api/elevate/players/game-stats', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
