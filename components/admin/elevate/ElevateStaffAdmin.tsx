...
export default function ElevateStaffAdmin() {
  ...
  const handleAddStaff = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/elevate/staff', {
        method: 'POST',
  ...
  const handleRemoveStaff = async (id: string) => {
    ...
    try {
      const response = await fetch(`/api/elevate/staff?id=${id}`, {
        method: 'DELETE'
      });
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="flex items-center px-4 py-2 bg-[#8cd2fe] text-white rounded-lg hover:bg-blue-400 transition-colors"
        >
          ...
          <form onSubmit={handleAddStaff} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#8cd2fe] dark:bg-gray-700 dark:text-white"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#8cd2fe] dark:bg-gray-700 dark:text-white"
              >
