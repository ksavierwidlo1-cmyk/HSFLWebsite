    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8 flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">Find and view Elevate 302 player profiles</p>
        </div>
      </div>
      ...
      <div className="mb-8">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none transition-colors text-gray-900 dark:text-white shadow-sm"
          ...
          filteredPlayers.map((player) => {
            ...
            return (
              <Link
                ...
                className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 hover:border-[#8cd2fe] dark:hover:border-[#8cd2fe] transition-all transform hover:scale-105 shadow-sm"
              >
