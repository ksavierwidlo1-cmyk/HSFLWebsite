        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex bg-white dark:bg-gray-800 rounded-lg p-1 shadow-lg">
            <button
              ...
              style={viewMode === 'overall' ? { backgroundColor: '#8cd2fe' } : {}}
            >
              Overall
            </button>
            <button
              ...
              style={viewMode === 'eastern' ? { backgroundColor: '#8cd2fe' } : {}}
            >
              Eastern
            </button>
            <button
              ...
              style={viewMode === 'western' ? { backgroundColor: '#8cd2fe' } : {}}
            >
              Western
            </button>
          </div>
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {standings.map((standing, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <Link
                        href={`/elevate/teams/${standing.team.id}`}
                      ...
                      >
                        ...
                        <div>
                          <div className="font-semibold text-gray-900 dark:text-white group-hover:opacity-80">
                            {standing.team.name}
                          </div>
