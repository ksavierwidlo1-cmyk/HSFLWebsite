    ...
    <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
      ...
      <div className="mb-6 sm:mb-8 flex items-center space-x-3 sm:space-x-4">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-1 sm:mb-2 flex items-center" style={{ color: '#8cd2fe' }}>
            <SettingsIcon className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 mr-2 sm:mr-3" />
            Settings
          </h1>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-5 md:p-6 border border-gray-200 dark:border-gray-700 mb-4 sm:mb-6 shadow-sm">
        <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
          <Palette className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: '#8cd2fe' }} />
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-5 md:p-6 border border-gray-200 dark:border-gray-700 mb-4 sm:mb-6 shadow-sm">
        <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
          <Eye className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: '#8cd2fe' }} />
