...
export default function ElevateTeamPage({ params }: { params: { id: string } }) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                <Trophy className="w-6 h-6 mr-2" style={{ color: '#8cd2fe' }} />
                Team Statistics
              </h2>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                <TrendingUp className="w-6 h-6 mr-2" style={{ color: '#8cd2fe' }} />
                Team Leaders
              </h2>
                ...
                <div className="space-y-4">
                  {pointsLeader && (
                    <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      ...
                      <div className="text-2xl font-bold" style={{ color: '#8cd2fe' }}>
          ...
          <div>
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg sticky top-4">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                <Users className="w-6 h-6 mr-2" style={{ color: '#8cd2fe' }} />
